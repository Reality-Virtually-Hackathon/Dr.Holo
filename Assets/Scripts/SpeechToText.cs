...
public class SpeechToText : MonoBehaviour
{
    ...
    void Update()
    {
		if (!toggle.isOn && (dictationRecognizer.Status != SpeechSystemStatus.Running)) {
			StartRecording ();
		} 
		if ((dictationRecognizer.Status != SpeechSystemStatus.Running) && toggle.isOn) {
			StopRecording ();
		}
    }
    ...
    public void StartRecording()
    {
        ...
        TextDisplay.GetComponent<Text>().text = "Dictation is starting. It may take time to display your text the first time, but begin speaking now...";

        Debug.Log("Start Recording Call: " + dictationRecognizer.Status);
    }
    ...
    public void StopRecording()
    {
        ...
        Debug.Log("Stop Recording Call: " + dictationRecognizer.Status);
    }
    ...
    private void DictationRecognizer_DictationHypothesis(string text)
    {
		...
		TextDisplay.GetComponent<Text>().text = textSoFar.ToString() + " " + text + "...";
    }
    ...
    private void DictationRecognizer_DictationResult(string text, ConfidenceLevel confidence)
    {
		...
		TextDisplay.GetComponent<Text>().text = textSoFar.ToString();
    }
    ...
    private void DictationRecognizer_DictationComplete(DictationCompletionCause cause)
    {
        ...
        {
            TextDisplay.GetComponent<Text>().text = "Dictation has timed out. Please press the record button again.";
        }
    }
    ...
    private void DictationRecognizer_DictationError(string error, int hresult)
    {
		...
		TextDisplay.GetComponent<Text>().text = error + "\nHRESULT: " + hresult;
    }
